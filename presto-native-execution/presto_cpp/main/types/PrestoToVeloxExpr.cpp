...
// SWITCH / CASE expression in Presto can be of two forms, searched and simple:
// https://prestodb.io/docs/current/functions/conditional.html#case.
// Velox only supports the searched form of SWITCH, so the first argument to
// SWITCH is removed when the input is in simple form.
